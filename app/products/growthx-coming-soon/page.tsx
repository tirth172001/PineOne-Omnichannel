...
export default function GrowthXComingSoonPage() {
  return (
    <V2DashboardLayout>
      <PageHeader
        title="Products · GrowthX"
        subtitle="GrowthX is coming soon"
          ...
          <Card className="w-full rounded-lg border-border/70 bg-card/85">
            <CardContent className="p-6 md:p-7">
              <div className="flex flex-col items-center text-center">
                ...
                <h2 className="mt-3 text-base font-semibold text-foreground">GrowthX will be available soon</h2>
                <p className="mt-1 max-w-2xl text-sm text-muted-foreground">
                  We are building merchant growth journeys for retention, conversion uplift, and lifecycle automation.
                </p>
