...
export default function GiftCardsComingSoonPage() {
  return (
    <V2DashboardLayout>
      <PageHeader
        title="Products · Gift cards"
        subtitle="Gift cards are coming soon"
          ...
          <Card className="w-full rounded-lg border-border/70 bg-card/85">
            <CardContent className="p-6 md:p-7">
              <div className="flex flex-col items-center text-center">
                ...
                <h2 className="mt-3 text-base font-semibold text-foreground">Gift cards will be available soon</h2>
                <p className="mt-1 max-w-2xl text-sm text-muted-foreground">
                  We are preparing gift card issuance, redemption, and reconciliation workflows for this workspace.
                </p>
