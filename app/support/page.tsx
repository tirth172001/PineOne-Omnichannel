      ...
      <div className="grid gap-3 sm:grid-cols-3">
        <Card className="rounded-lg border-border/70 bg-card/80">
          <CardContent className="p-3">
            ...
            <p className="mt-1 text-[18px] font-semibold text-foreground">8</p>
          </CardContent>
        </Card>
        <Card className="rounded-lg border-border/70 bg-card/80">
          <CardContent className="p-3">
            <p className="text-[10px] uppercase tracking-wider text-muted-foreground">In progress</p>
            <p className="mt-1 text-[18px] font-semibold text-foreground">5</p>
          </CardContent>
        </Card>
        <Card className="rounded-lg border-border/70 bg-card/80">
          <CardContent className="p-3">
            <p className="text-[10px] uppercase tracking-wider text-muted-foreground">Resolved this week</p>
            <p className="mt-1 text-[18px] font-semibold text-foreground">19</p>
          </CardContent>
        </Card>
      </div>
...
export default function SupportPage() {
  ...
  const section = useMemo<"knowledge" | "queries">(() => {
    if (
      pathname.startsWith("/support/knowledge-hub") ||
      pathname.startsWith("/support/faqs") ||
      pathname.startsWith("/support/training-videos")
    ) {
      return "knowledge"
    }
    return "queries"
